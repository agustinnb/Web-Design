		...
		<div id="wrapper">	
			...
			<div id="main_container" class="main_container container_16 clearfix">
				...
				<div class="box grid_8">
					<h2 class="box_head grad_colour round_top">Grid_8</h2>
				...
				<div class="box grid_4">
					<h2 class="box_head grad_colour round_top">Grid_4</h2>
					<a href="#" class="grabber">&nbsp;</a>
					<a href="#" class="toggle">&nbsp;</a>
					<div class="toggle_container">					
						<div class="block">
				...
				<div class="box grid_16">
					<h2 class="box_head grad_colour round_top">Grid_16</h2>
					<a href="#" class="grabber">&nbsp;</a>
					<a href="#" class="toggle">&nbsp;</a>
					<div class="toggle_container">					
						<div class="block">
				...
				<div class="box grid_16">
					<h2 class="box_head grad_colour round_top">Grid_16 <small>(Closed by default)</small></h2>
					<a href="#" class="grabber">&nbsp;</a>
				...
				<div class="box grid_4">
					<h2 class="box_head grad_colour round_top">Grid_4 <small>(Closed)</small></h2>
					<a href="#" class="grabber">&nbsp;</a>
					<a href="#" class="toggle toggle_closed">&nbsp;</a>
					<div class="toggle_container" style="display:none;">					
						<div class="block">
				...
				<div class="box grid_8">
					<h2 class="box_head grad_colour round_top">Grid_8 <small>(Closed by default)</small></h2>
					<a href="#" class="grabber">&nbsp;</a>
					<a href="#" class="toggle toggle_closed">&nbsp;</a>
					<div class="toggle_container" style="display:none;">					
						<div class="block">
